...
module.exports = {
  ...
  run: async(client, message, args) => {
        ...
        if(userBalance < itemPrice) return message.channel.send(`**You do not have sufficient OctaCreds to buy that item!**`)
        ...
        inventory.findOne(params, async(err, data) => {
            ...
            message.channel.send(`**You have successfullly bought a \`${itemToBuy}\`**`)
