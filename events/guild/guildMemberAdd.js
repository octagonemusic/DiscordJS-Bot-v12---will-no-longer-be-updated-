      ...
      .addFields(
        {
          ...
          value: client.channels.cache.get("832479548129673217"),
        },
        {
          name: "Please read the rules over here:",
          value: client.channels.cache.get("832478489448808498"),
        }
      )
      .setColor("#ffc200")
      .setImage("https://media.giphy.com/media/FWVzupqhhcRFsIRsEv/giphy.gif")
      .setFooter(`Thank you for joining!`, member.user.displayAvatarURL())
      .setTimestamp()
  
    if (member.guild.id === "832467028802797578") {
      client.channels.cache.get("832479476511670322").send(`${member}`, embed)
    }
